/**
 * Dimmer Switch with Minimum
 *
 * Based off of Enhanced GE/Jasco Dimmer Switch by Ben W. (@desertBlade)
 *
...
metadata {
	definition (name: "DesertBlade Enhanced Dimmer Switch", namespace: "desertblade", author: "Ben W.") {
...
private dimmerEvents(physicalgraph.zwave.Command cmd) {
	...
	if (cmd.value && cmd.value <= 100) {
        if (cmd.value < 30) {
            log.trace "setting minimum level to 30 in dimmerEvents()"
            cmd.value = 30
        }
